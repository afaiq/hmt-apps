...
class KeprofScreen extends Component {
    ...
    componentDidMount(){
        return fetch('http://hmt.mining.itb.ac.id/wp-json/wp/v2/posts?categories=6')
    ...
    static navigationOptions = ({ navigation }) => ({
        title: "Info Keprofesian",
        headerLeft: <Icon name="ios-menu" style={{ paddingLeft: 10 }} onPress={() => navigation.navigate('DrawerOpen')} />,
        drawerIcon:
            <Image
                source={require('../assets/pick-and-shovel.png')}
                style={styles.icon}
            />
